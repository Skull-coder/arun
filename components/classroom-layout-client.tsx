...
import { 
  ...
  ChevronLeft, ChevronRight, BarChart, GraduationCap, Menu
} from "lucide-react";
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-auto md:h-[72px] shrink-0 flex flex-col md:flex-row md:items-center justify-between border-b border-border/40 bg-card/80 backdrop-blur-xl px-4 md:px-8 py-4 md:py-0 sticky top-0 z-10 shadow-sm gap-4 md:gap-0">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="flex h-10 w-10 md:h-11 md:w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white shadow-inner shrink-0">
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-center gap-2 mt-1 md:mt-1.5 flex-wrap">
                <span className="text-[10px] md:text-xs font-semibold text-muted-foreground uppercase tracking-widest">Educator View</span>
